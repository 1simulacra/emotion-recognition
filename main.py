...
# LMF
hyp_params.rank = 8
hyp_params.LMFoutput_dim = 180
if dataset == 'iemocap':
    if args.aligned:
        hyp_params.hidden_dims = (20, 20, 20)
    else:
        hyp_params.hidden_dims = (400, 500, 20)
elif dataset == 'mosi':
    if args.aligned:
        hyp_params.hidden_dims = (50, 50, 50)
    else:
        hyp_params.hidden_dims = (375, 500, 50)
elif dataset == 'mosei_senti':
    if args.aligned:
        hyp_params.hidden_dims = (50, 50, 50)
    else:
        hyp_params.hidden_dims = (500, 500, 50)
